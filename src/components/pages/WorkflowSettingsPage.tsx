    ...
    >
      <div className="max-w-[760px] mx-auto mt-8 rounded-2xl border border-[#2b3142] bg-[#121723]/95 p-6 shadow-2xl">
        <div className="flex items-center justify-between mb-5">
          <div className="text-xl font-semibold text-white">项目设置</div>
        </div>
        <div className="space-y-4">
          <label className="block">
            <div className="text-xs text-gray-300 mb-1">项目名称</div>
            <input value={workflowName} onChange={(e) => setWorkflowName(e.target.value)} className="w-full bg-[#111215] border border-[#303443] rounded px-3 py-2 text-sm" placeholder="请输入项目名称" />
          </label>
