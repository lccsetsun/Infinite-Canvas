...
export default function ProjectGalleryPage({
  ...
  const handleCreateProject = React.useCallback(() => {
    ...
    onProjectsChanged();
    onOpenCanvas(projectId);
  }, [onOpenCanvas, onProjectsChanged]);
  ...
  const finalizeInlineRename = React.useCallback(
    ...
    [inlineRenameState, onProjectsChanged]
  );
  ...
  const handleRenameProject = React.useCallback(
    ...
    [inlineRenameState, onProjectsChanged, projects]
  );
  ...
  }, [coverDialogState, onProjectsChanged]);
        ...
        <main className="mx-auto w-full max-w-[1920px] px-10 pb-14 pt-12">
          <div className="mb-8 flex items-end justify-between">
            <div>
              ...
              <div className="mt-1.5 text-[12px] text-slate-500">{subtitle}</div>
            </div>
