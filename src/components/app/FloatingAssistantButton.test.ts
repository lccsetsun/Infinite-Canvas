...
describe("FloatingAssistantButton", () => {
  it("shows a hover helper bubble and opens the assistant panel from the icon", () => {
    ...
    expect(source).toContain("awoawo-bot-icon-no-eyes.png");
    expect(source).toContain("function AssistantMascot");
    expect(source).toContain("assistant-mascot-animated-eye");
    expect(source).toContain("assistantMascotBlinkTransition");
    expect(source).toContain("assistantMascotGreetingTransition");
    expect(source).toContain("assistantMascotSparkClassName");
    expect(source).toContain("relative h-[64px] w-[64px]");
    expect(source).toContain("h-[64px] w-[64px] object-contain");
    expect(source).toContain("right-[-12%] top-[-10%]");
    expect(source).toContain("h-[72px] w-[72px]");
    expect(source).toContain("panelGreeting");
    expect(source).not.toContain("awoawo-bot-icon.png");
    expect(source).not.toContain("assistant-mascot-screen-eye");
    expect(source).not.toContain("assistant-mascot-eye-cover");
    expect(source).not.toContain("left-[36.6%]");
    ...
    expect(source).toContain("h-[132px] w-[132px]");
    expect(source).toContain("scale: [0.96, 1.04, 0.96]");
    expect(source).toContain("scale: [0.72, 1.08]");
    expect(source).toContain("bg-violet-200/12 blur-xl");
    expect(source).toContain("right-8 top-6");
    expect(source).toContain("left-8 top-7");
    expect(source).toContain("bottom-4 h-4 w-14");
    expect(source).toContain("scaleX: [1, 0.78, 1]");
    expect(source).toContain("x: [0, index === 1 ? -5 : 4, 0]");
    expect(source).toContain("y: [0, -2, 0]");
    ...
    expect(source).toContain("leading-[1.42]");
